...
const Contacts = () => {
  ...
  const columns = [
...

    {
      title: "",
      dataIndex: "star",
      render: (text, record) => <i className="fa fa-star"></i>,
              ...
              <div className="col">
                <div className="dropdown">
                  ...
                  <div className="dropdown-menu">
                    ...
                    <a className="dropdown-item" href="#">
                      Contacts added in the last 24 hours
                    </a>
                    <a className="dropdown-item" href="#">
                      Contacts added in the last 7 days
                    </a>
                    <a className="dropdown-item" href="#">
                      Contacts with no notes in the last month
                    </a>
                    <a className="dropdown-item" href="#">
                      Contacts with no notes in the last 7 days
                    </a>
                  </div>
                </div>
              </div>
