                ...
                <Page size="A4" style={Styles.body}>
                    <View style={{margin:0,padding:5}}>
                        <View style={{width:'100%',margin:0,padding:0,border:0,flexDirection:'row',flexGrow:0}}>
                            ...
                            <View style={{width:'60%',margin:0,padding:0,borderBottom:0,borderLeft:2,borderRight:2,borderTop:2,borderColor:'#ff0505',flexDirection:'row'}}>
                                ...
                                <View style={{flexDirection:'column',border:0,flexGrow:1}}>
                                    <View style={{height:22,borderBottom:1,borderColor:'#ff0505',alignItems:'stretch',alignContent:'center',flexDirection:'row'}}>
                                        <View style={{width:50,borderRight:2,borderColor:'#ff0505',alignItems:'center',flexGrow:0}}>
                                            <View style={{}}>
                                    ...
                                    <View style={{height:22,borderBottom:1,borderColor:'#ff0505',alignItems:'stretch',alignContent:'center',flexDirection:'row'}}>
                                        <View style={{width:50,borderRight:2,borderColor:'#ff0505',flexGrow:0}}>
                                            <View style={{alignItems:'center'}}>
                                                <Text style={Styles.textCenterUpper}>상   호</Text>
                                                <Text style={Styles.textCenterLower}>(법인명)</Text>
                                            </View>
                                        </View>
                                        <View style={{borderRight:1,borderColor:'#ff0505',flexGrow:1}}>
                                            <View style={{alignItems:'center'}}>
                                                <Text style={Styles.textCenter}>{transaction.company_name}</Text>
                                            </View>
                                        </View>
                                        <View style={{width:20,borderRight:1,borderColor:'#ff0505',flexGrow:0}}>
                                            <View style={{alignItems:'center'}}>
                                    ...
                                    <View style={{height:22,borderBottom:1,borderColor:'#ff0505',alignItems:'center',alignContent:'center',flexDirection:'row'}}>
                                        <View style={{width:50,borderRight:2,borderColor:'#ff0505',flexGrow:0}}>
                                    ...
                                    <View style={{height:22,border:0,flexDirection:'row',alignItems:'center',alignContent:'center'}}>
                                        ...
                                        <View style={{borderRight:1,borderColor:'#ff0505',flexGrow:2}}>
                        ...
                        <View style={{width:'100%',margin:0,padding:0,border:2,borderColor:'#ff0505',flexDirection:'column',flexGrow:1}}>
                            <View style={{width:'100%',height:36,margin:0,padding:0, borderBottom:2,borderColor:'#ff0505',flexDirection:'row'}}>
                                <View style={{width:'40%',height:'100%',margin:0,justifyContent:'center',border:0}}></View>
                                <View style={{width:'60%',height:'100%',margin:0,justifyContent:'center',borderLeft:2,borderColor:'#ff0505'}}></View>
                            </View>
                            <View style={{width:'100%',height:200,margin:0,padding:0,borderBottom:2,borderColor:'#ff0505',flexDirection:'column'}}>
                            ...
                            <View style={{width:'100%',height:36,margin:0,padding:0,borderBottom:2,borderColor:'#ff0505',flexDirection:'column'}}>
