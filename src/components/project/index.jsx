  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <>
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#project-details">
            {text}{" "}
          </a>
        </>
      ),
    ...
    },
    {
      ...
      render: (text, record) => (
        <>
          <a href="#" data-bs-toggle="modal" data-bs-target="#system-user">
            {text}
          </a>
        </>
      ),
        ...
        <>
          <div className="pipeline-small flat pipeline-project">
            <a
              ...
              data-placement="top"
              title=""
              data-original-title="Pipeline: Deal Pipeline, stage: plan"
            >
              &nbsp;
              <span
            ...
            <a
              ...
              data-placement="top"
              title=""
              data-original-title="Pipeline: Deal Pipeline"
            >
              <span
                className="stretched-link"
                data-bs-toggle="modal"
