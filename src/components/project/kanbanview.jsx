            ...
            <div className="col-md-12 grid-margin stretch-card kanban">
              <div>
                <div className="card-body p-0 row">
                  <div
                    id="sortableKanbanBoards"
                    className="col-md-12 kanban-views p-0"
                  >
                        ...
                        <div id="TODO" className="kanban-centered">
                          ...
                          >
                            <div className="kanban-entry-inner">
                              <div
                                className="kanban-label card bg-gradient-danger card-img-holder text-white h-100"
                                data-bs-toggle="modal"
                                data-target="#leads-details"
                              >
                                <img
                                  src={CircleImg}
                          ...
                          >
                            <div className="kanban-entry-inner">
                              <div
                                className="kanban-label card bg-gradient-info card-img-holder text-white h-100"
                                data-bs-toggle="modal"
                                data-target="#leads-details"
                              >
                                <img
                          ...
                          >
                            <div className="kanban-entry-inner">
                              <div
                                className="kanban-label card bg-gradient-success card-img-holder text-white h-100"
                                data-bs-toggle="modal"
                                data-target="#leads-details"
                              >
                                <img
                      ...
                      <div className="panel-body slimScrollDiv">
                        <div id="DOING" className="kanban-centered">
                          ...
                          >
                            <div className="kanban-entry-inner">
                              <div
                                className="kanban-label card bg-gradient-warning card-img-holder text-white h-100"
                                data-bs-toggle="modal"
                                data-target="#leads-details"
                              >
                                <img
              ...
              <div className="modal-body">
                <form className="forms-sample">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      className="btn btn-gradient-primary me-2 btn-rounded"
                    >
                      Submit
                    </button>
                    <button className="btn btn-light cancel-button rounded">
                      Cancel
                    </button>
                  </div>
                </form>
