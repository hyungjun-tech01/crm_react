...
import { atomCurrentUser, defaultUser, atomCurrentModifyUser } from "../../atoms/atomsUser";
...
const UserDetailsModel = () => {
  ...
  const selectedUser = useRecoilValue(atomCurrentModifyUser);
                            ...
                            <table className="table">
                              <tbody>
                                <tr className='detail-tr'>
                                    <td className={"detail-td-left " + "border-0"}>{t('user.user_id')}</td>
                                    <td className={"detail-td-center " + "border-0" } >
                                        <input
                                            autoFocus
                                            className='detail-edit-label'
                                            type={"text"}
                                            placeholder={t('user.user_id')}
                               ...
                               <DetailLabelItem
                                ...
                                />     
                               <DetailLabelItem
                                  defaultText={selectedUser.jobType}
                                  saved={savedValues}
                                  name="jobType"
