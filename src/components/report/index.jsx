              ...
              <div className="card">
                <div className="card-body">
                  <p className="m-0">
                    ...
                    <a href="#">articles</a> or watch the <a href="#">video</a>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row all-reports m-0">
            ...
            <div className="col-md-8 pr-0 Reports">
              <div className="tab-content pt-0">
                ...
                <div className="tab-pane" id="contact-reports" role="tabpanel">
                  <div className="table-responsive card">
                    <div className="card-body">
                ...
                <div className="tab-pane" id="company-reports" role="tabpanel">
                  <div className="table-responsive card">
                    <div className="card-body">
                ...
                <div className="tab-pane" id="project-reports" role="tabpanel">
                  <div className="table-responsive card">
                    <div className="card-body">
          ...
          <div className="modal-dialog" role="document">
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="mb-0">
                  <img src={ReportsImg} alt="Report" className="report-img" />
                  &nbsp;&nbsp;Add New Report
                </h4>
                <button
                  type="button"
