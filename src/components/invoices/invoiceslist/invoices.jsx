                    ...
                    <ul className="app-listing">
                      <li>
                        <div className="multipleSelection">
                          ...
                          <div
                            id="checkBoxes"
                            style={{ display: isShown1 ? "none" : "block" }}
                          >
                            <form action="#">
                      ...
                      <li>
                        <div className="multipleSelection">
                          ...
                          <div
                            id="checkBoxes"
                            style={{ display: isShown3 ? "none" : "block" }}
                          >
                            <form action="#">
                      ...
                      <li>
                        <div className="multipleSelection">
                          ...
                          <div
                            id="checkBoxes"
                            style={{ display: isShown4 ? "none" : "block" }}
                          >
                            <form action="#">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link
                              to="/invoices-paid"
                              className={`${
                                pathname.includes("invoices-paid")
                                  ? "active"
                                  : ""
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              to="/invoices-overdue"
                              className={`${
                                pathname.includes("invoices-overdue")
                                  ? "active"
                                  : ""
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              to="/invoices-draft"
                              className={`${
                                pathname.includes("invoices-draft")
                                  ? "active"
                                  : ""
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              ...
                              className={`${
                                pathname.includes("invoices-cancelled")
                                  ? "active"
                                  : ""
                              }`}
                            >
