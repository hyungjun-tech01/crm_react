  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <>
          ...
          <a href="#" data-bs-toggle="modal" data-bs-target="#deal-details">
            {text}{" "}
          </a>
        </>
      ),
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="pipeline-small flat ">
          <a
            className={record.text1}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Prospecting"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
              data-bs-target="#deal-details"
            />
          </a>
          <a
            className={record.text2}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Qualification"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
          ...
          <a
            className={record.text3}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Needs Analysis"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
          ...
          <a
            className={record.text4}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Proposal"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
          ...
          <a
            className={record.text5}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Negotiation"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
          ...
          <a
            className={record.text6}
            data-bs-toggle="tooltip"
            data-bs-placement="top"
            data-bs-original-title="stage: Closed Won"
          >
            <span
              className="stretched-link"
              data-bs-toggle="modal"
    ...
    },
    {
      ...
      sorter: (a, b) =>
        a.forecast_close_date.length - b.forecast_close_date.length,
    },
    {
      ...
      render: (text, record) => (
        <div className="dropdown dropdown-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <a className="dropdown-item" href="#">
              Add New Task For Deal
            </a>
            <a className="dropdown-item" href="#">
              Add New Event For Deal
            </a>
            <a className="dropdown-item" href="#">
              Add Activity Set To Deal
            </a>
            <a className="dropdown-item" href="#">
              Convert To Deal
            </a>
                ...
                <ul className="list-inline-item pl-0">
                  <li className="nav-item dropdown list-inline-item add-lists">
                    ...
                    >
                      ...
                      <Link className="dropdown-item" to="/deals-kanban-view">
                        Kanban View
                      </Link>
                      <a
